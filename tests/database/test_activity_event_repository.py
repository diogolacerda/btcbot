...
@pytest.fixture
def repository(session: Session) -> ActivityEventRepository:
...
class TestActivityEventRepository:
    ...
    def test_create_event_with_string_type(
        self,
        repository: ActivityEventRepository,
        account: Account,
    ):
    ...
    def test_create_event_with_custom_timestamp(
        self,
        repository: ActivityEventRepository,
        account: Account,
    ):
    ...
    def test_get_events_by_account(
        self,
        repository: ActivityEventRepository,
        account: Account,
    ):
        ...
        # Act
        events = repository.get_events_by_account(account.id)
    ...
    def test_get_events_by_account_with_pagination(
        self,
        repository: ActivityEventRepository,
        account: Account,
    ):
        ...
        # Act
        page1 = repository.get_events_by_account(account.id, limit=3, offset=0)
        page2 = repository.get_events_by_account(account.id, limit=3, offset=3)
    ...
    def test_get_events_by_type(
        ...
        # Act
        events = repository.get_events_by_type(
            account_id=account.id,
            event_type=EventType.ORDER_FILLED,
        )
    ...
    def test_count_events_by_account(
        self,
        repository: ActivityEventRepository,
        account: Account,
    ):
        ...
        # Act
        count = repository.count_events_by_account(account.id)
    ...
    def test_delete_old_events(
        ...
        # Act
        deleted_count = repository.delete_old_events(
            account_id=account.id,
        ...
        remaining = repository.get_events_by_account(account.id)
        assert len(remaining) == 1
        assert remaining[0].description == "Recent"

    def test_events_isolated_by_account(
        self,
        repository: ActivityEventRepository,
        session: Session,
        user: User,
        ...
        # Act
        events1 = repository.get_events_by_account(account1.id)
        events2 = repository.get_events_by_account(account2.id)
