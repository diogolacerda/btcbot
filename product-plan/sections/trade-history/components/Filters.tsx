...
import type { TradeFilters, TradeFilterStatus, TradeProfitFilter } from '@/../product/sections/trade-history/types'
...
export function Filters({ filters, onFiltersChange, onSearch }: FiltersProps) {
  ...
  const handleEntryPriceChange = (min: string, max: string) => {
    ...
    if (minValue !== undefined || maxValue !== undefined) {
      ...
      const { entryPriceRange, ...rest } = filters || {}
  ...
  const handleDurationChange = (min: string, max: string) => {
    ...
    if (minValue !== undefined || maxValue !== undefined) {
      ...
      const { durationRange, ...rest } = filters || {}
      onFiltersChange?.(rest)
    }
  }
  ...
  const handleQuantityChange = (min: string, max: string) => {
    ...
    if (minValue !== undefined || maxValue !== undefined) {
      ...
      const { quantityRange, ...rest } = filters || {}
      onFiltersChange?.(rest)
    }
  }
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <input
                  ...
                  onChange={(e) =>
                    handleEntryPriceChange(e.target.value, filters?.entryPriceRange?.max?.toString() || '')
                  }
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleEntryPriceChange(filters?.entryPriceRange?.min?.toString() || '', e.target.value)
                  }
                  className="px-3 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 dark:focus:ring-emerald-400"
                />
              </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <input
                  ...
                  onChange={(e) =>
                    handleDurationChange(e.target.value, filters?.durationRange?.max?.toString() || '')
                  }
                  className="px-3 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 dark:focus:ring-emerald-400"
                />
                <input
                  ...
                  onChange={(e) =>
                    handleDurationChange(filters?.durationRange?.min?.toString() || '', e.target.value)
                  }
                  className="px-3 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 dark:focus:ring-emerald-400"
                />
              </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <input
                  ...
                  onChange={(e) =>
                    handleQuantityChange(e.target.value, filters?.quantityRange?.max?.toString() || '')
                  }
                  className="px-3 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 dark:focus:ring-emerald-400"
                />
                <input
                  ...
                  onChange={(e) =>
                    handleQuantityChange(filters?.quantityRange?.min?.toString() || '', e.target.value)
                  }
                  className="px-3 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 dark:focus:ring-emerald-400"
                />
              </div>
