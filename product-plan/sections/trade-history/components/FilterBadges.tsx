...
import type { TradeFilters } from '@/../product/sections/trade-history/types'
...
export function FilterBadges({ filters, onRemoveFilter, onClearFilters }: FilterBadgesProps) {
  ...
  if (filters?.entryPriceRange) {
    ...
    activeFilters.push({ key: 'entryPriceRange', label: `Entry: ${minLabel} - ${maxLabel}` })
  }
  ...
  if (filters?.durationRange) {
    ...
    activeFilters.push({ key: 'durationRange', label: `Duration: ${minLabel} - ${maxLabel}` })
  }
  ...
  if (filters?.quantityRange) {
    ...
    activeFilters.push({ key: 'quantityRange', label: `Quantity: ${minLabel} - ${maxLabel}` })
  }
