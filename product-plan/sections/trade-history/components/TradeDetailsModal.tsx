...
import type { Trade } from '@/../product/sections/trade-history/types'
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-700 dark:text-slate-300 mt-1">{trade.leverage}x</p>
              </div>
              <div>
          ...
          <div>
            ...
            <div className="bg-slate-50 dark:bg-slate-900 rounded-lg p-4 space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-sm text-slate-600 dark:text-slate-400">Trading Fee</span>
                <span className="text-sm font-mono text-slate-700 dark:text-slate-300">
                  {formatCurrency(trade.fees.tradingFee)}
                </span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-slate-600 dark:text-slate-400">Funding Fee</span>
                <span className="text-sm font-mono text-slate-700 dark:text-slate-300">
